...
// const upload = multer({ storage: storage }); // Move this line up to define upload before using it
...
//         const { textInput, fontFamily, fontSize, selectedColor, name, phone1, phone2, address, estimatedCost} = req.body;
        
        
//         // Define the pricing based on font size
//         const pricing = {
//             small: 200,
//             medium: 400,
//             large: 600
...
//             phone2,
//             address,
//             images, // Use the array of filenames for images
//             estimatedCost, // Calculated on the server side
//         });

//         await newRequest.save();
//         req.flash("success", "Success! You will be contacted in a while");
